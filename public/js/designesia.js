  ...
  function custom_elements() {
    ...
    jQuery(".de_nav li").on("click", function () {
      ...
      jQuery(this)
        ...
        .fadeTo("slow", 1); //uses whatever index the link has to open the corresponding box
  ...
  function init_de() {
    ...
    jQuery(".item .picframe")
      .on("mouseenter", function () {
        ...
        jQuery(this).parent().find(".overlay").stop(true).fadeTo(200, 0.8);
