...
export default function AnniversaryCounter() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-cream to-rose-petal/40 py-24 sm:py-28">
      <div className="container-wed">
        ...
        <Reveal delay={0.15}>
          <p className="mt-10 text-center font-serif text-xl italic text-wine">
            {future
