          ...
          <Reveal direction="right">
            <TiltCard max={7} className="overflow-hidden rounded-[2rem] shadow-soft">
              <div className="relative aspect-[3/4] w-full">
                ...
                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-wine-deep/80 to-transparent p-6 text-center">
        ...
        <div className="space-y-10">
          {bio.paragraphs.map((p, i) => (
            <Reveal key={p.heading} delay={i * 0.08} direction="left">
              <article>
                <h3 className="flex items-center gap-3 font-display text-2xl text-wine-deep">
