      ...
      >
        {images.map((src, i) => (
          ...
          >
            ...
            />
            <span className="absolute inset-0 flex items-center justify-center bg-ink-deep/0 opacity-0 transition group-hover:bg-ink-deep/40 group-hover:opacity-100">
